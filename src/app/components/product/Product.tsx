  ...
  return (
    <div className="bg-white w-[217px] ms-8 mt-14 flex flex-col gap-2 items-center py-4 rounded-3xl shadow-xl">
      <Link href={`/products/${productId}`} className="h-[170px] w-[120px]">
        <Image src={productImage} alt="product_image" className="w-32 h-44 object-cover" />
      </Link>
      ...
      <button className="bg-primary text-white w-[105px] h-[30px] rounded-full text-xs" onClick={handleAddToCart}>
        Sepete Ekle
      </button>
    </div>
  );
